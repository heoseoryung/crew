...
import Chart from 'chart.js/auto';//auto:미리 다 조립해서 통째로 가져오는 방식 
/**
 * chart.js/auto가 자동으로 가져오는 핵심 부품들:
 * - Renderer: 캔버스에 실제로 그림을 그려주는 역할 (화가)
 * - Controller: 차트의 형태(Line, Bar 등)를 제어하는 역할 (감독)
 * - Scale: 축(X, Y)의 눈금과 숫자를 계산하는 역할 (자/Ruler)
 * - Tooltip: 데이터에 마우스를 올렸을 때 나타나는 정보창 (말풍선)
 */
